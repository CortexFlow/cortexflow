  ...
  return (
    <>
      <div data-aos="fade-up">
        <div className="bg-white lg:py-4 sm:py-32 md:py-2">
          <div className="mx-auto lg:max-w-7xl gap-x-8 gap-y-16 px-6 lg:px-8 md:max-w-3xl md:px-4">
            <div className="mx-auto lg:text-center md:text-center ">
              <div className="container section-title" data-aos="fade-up">
                <h2 className="text-xl">🐝 eBPF Powered Technology</h2>
              </div>
              <p
                className="w-full mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 
              sm:text-5xl lg:text-balance xs:text-4xl text-center "
              >
                Everything you need to monitor your cluster
              </p>
            </div>
            <div className=" p-3.5 mx-auto mt-16 sm:mt-20 lg:mt-24 lg:max-w-7xl">
              <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                <div className="relative pl-16">
                  <dt className="text-xl font-semibold text-gray-900">
                    <div className="absolute left-0 top-0 flex size-10 items-center justify-center rounded-lg bg-yellow-400">
                      <svg
                  ...
                  <dd className="mt-2 text-base/8  text-gray-600">
                ...
                <div className="relative pl-16">
                  <dt className="text-xl font-semibold text-gray-900">
                    <div className="absolute left-0 top-0 flex size-10 items-center justify-center rounded-lg bg-red-500">
                      <svg
                        className="size-6 text-white"
                        fill="none"
                        viewBox="0 0 24 24"
